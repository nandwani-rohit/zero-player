function [solutions, f_values, f2_values] = ABC(Np, T, objective, lb, ub, d, limit)
...
%     starter = P;
    ...
    for t = 1:T
        ...
        for i = 1:Np
            ...
            f2_new = fitness(objective, X_new);
        ...
        f2_values(t+1) = fitness(objective, solutions(t+1,:));
        ...
        if val > limit
            ...
            f2(ind) = fitness(objective, P(ind,:));
        end
...
function f2 = fitness(objective, X)
    f1 = objective(X);
    if f1 >= 0
        f2 = 1/(1+f1);
    else
