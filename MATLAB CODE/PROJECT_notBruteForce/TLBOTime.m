function [solutions, f_values, c_values, a_values, starter] = TLBOTime(Np, T, fitness, lb, ub, d)
    ...
    for i = 1:T
        ...
        % --------------------------------------------------------------
            ...
            [f_new, c_new, a_new] = fitness(X_new);
        ...
        c_values(i+1) = counter(j_best);
        a_values(i+1) = actual(j_best);
    end
end
